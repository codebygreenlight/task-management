            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className={`flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition duration-200
                  ${task.completed 
                    ...
                    : 'border-mint-400 hover:border-emerald-500'
                  }`}
              >
                {task.completed && (
              ...
              <div className="flex-grow">
                <div className="flex items-center justify-between">
                  <h3 className={`font-medium ${task.completed ? 'text-mint-300/50 line-through' : 'text-mint-100'}`}>
                    {task.title}
                  </h3>
                  {task.scheduledFor && (
                    <span className="text-sm text-mint-400 flex items-center">
                ...
                {task.description && (
                  <p className={`text-sm mt-1 ${task.completed ? 'text-mint-300/40' : 'text-mint-200/70'}`}>
                    {task.description}
                  </p>
                )}
              </div>
              <button
                ...
                className="flex-shrink-0 opacity-0 group-hover:opacity-100 text-mint-400 hover:text-red-400 transition duration-200"
              >
